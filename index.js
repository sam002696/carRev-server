...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.yftux.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
//Ia5FKcy5ZTCeoPBf
//caruser
...
app.listen(port, () => {
	console.log('Running Elite Carz servers on port', port);
});